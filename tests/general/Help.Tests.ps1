...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\Mutex\functions", "$global:testroot\..\Mutex\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\Mutex\functions"
    "$global:testroot\..\Mutex\internal\functions"
)
